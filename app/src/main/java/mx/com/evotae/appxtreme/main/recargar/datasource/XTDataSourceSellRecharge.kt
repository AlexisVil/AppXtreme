...
class XTDataSourceSellRecharge(private val callApi: XTSellRechargeApiCall )  {
    suspend fun sellReacharge(idOperacion: String,
                 user: String,
                 pwd: String,
                 ...
                 versionCode: String,
                 id: String,
                 numeroCelular: String): XTResponseData<XTResponseGeneral<XTResponseSellRecharge>?> {
        return callApi.sellRecharge(idOperacion,
            user,
            pwd,
            claveOperador,
            regId,
